...
import startandroidarch.feature.dashboard.impl.generated.resources.dashboard_network_error
    ...
    private fun observerData() = getUsersUseCase()
        ...
        .transform { users ->
            users.fold(
                ...
                onFailure = {
                    appLog.e(it)
                    emit(UpdateState(ContentState.Error(Res.string.dashboard_network_error)))
                }
            )
        }
}
